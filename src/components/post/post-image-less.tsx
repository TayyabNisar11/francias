...
const PostImageLess = ({
  ...
  //       return '/francais-et-vous/assets/images/icons/category-icon-desgin.png';
  //     case PostCoverType.VIDEO:
  //       return '/francais-et-vous/assets/images/icons/category-icon-graphic.png';
  //     case PostCoverType.AUDIO:
  //       return '/francais-et-vous/assets/images/icons/category-icon-technology.png';

  //     default:
  //       return '/francais-et-vous/assets/images/icons/category-icon-typography.png';
  //   }
  // };
  return (
